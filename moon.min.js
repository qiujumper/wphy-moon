...
if (jQuery(document).ready(function(a) {
    a(".repeat-group .add-field").click(function(b) {
        b.preventDefault(), $repeat_group = a(this).closest(".repeat-group"), $this_form = a(this).closest("form"), 
        $new_field = $repeat_group.find(".repeat-fields").last().clone(), $new_field.find("textarea,select,input:not(:button)").val(""), 
        $new_field.find("img").attr("src", ""), $fields = $repeat_group.find(".repeat-fields-area"), 
        $new_field.appendTo($fields);
    }), a(".repeat-group").on("click", ".remove-field", function(b) {
        b.preventDefault(), $repeat_fields = a(this).closest(".repeat-fields"), console.log($repeat_fields.html()), 
        $repeat_fields.fadeOut(300, function() {
            a(this).remove();
        });
    });
