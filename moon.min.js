...
if (jQuery(document).ready(function(a) {
    a(".repeat-group .add-field").click(function(b) {
        b.preventDefault(), $repeat_group = a(this).parent(".repeat-group"), $this_form = a(this).parent("form"), 
        $new_field = $repeat_group.find(".repeat-fields").last().clone(), $new_field.find("input,textarea,select").val(""), 
        $fields = $repeat_group.find(".repeat-fields-area"), $new_field.appendTo($fields);
    }), a(".repeat-group").on("click", ".remove-field", function(b) {
        b.preventDefault(), $repeat_fields = a(this).parent(".repeat-fields"), $repeat_fields.remove();
    });
