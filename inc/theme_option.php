...
function register_contact_settings() {
  ...
  register_setting( 'global-settings-group', "show_partner" );
...
function theme_option_html_wphy() {
  ...
  <div class="info">
    ...
    <blockquote>
      <p>欢迎使用wordpress花园的“月亮”主题！在Wordpress花园的官网(http://wordpresshy.com)上有详细的主题使用【配套视频教程】<br/>
        手把手让你零基础不求助任何人搭建起你自己的Wordpress网站！
        如果阁下在使用该主题的过程中有任何疑问<br/>
        可以发邮件到<span class="text-primary">wordpresshy@126.com</span>，或者到Wordpress网站对应的主题页面下留言
      </p>
    </blockquote>
    <p>
  ...
  <div role="tabpanel">
    ...
    <ul class="nav nav-tabs" role="tablist">
      <li role="presentation" class="active">
        <a href="#global" aria-controls="global" role="tab" data-toggle="tab">全局设置</a>
      </li>

      <li role="presentation">
        <a href="#slider" aria-controls="slider" role="tab" data-toggle="tab">幻灯片</a>
      </li>

      <li role="presentation">
        <a href="#intro" aria-controls="intro" role="tab" data-toggle="tab">首页介绍区块</a>
      </li>

      <li role="presentation">
        <a href="#contact" aria-controls="contact" role="tab" data-toggle="tab">联系方式</a>
      </li>

      <li role="presentation">
        <a href="#smallslider" aria-controls="smallslider" role="tab" data-toggle="tab">小幻灯片</a>
      </li>

      <li role="presentation">
        <a href="#block3" aria-controls="block3" role="tab" data-toggle="tab">首页3栏区块</a>
      </li>

      <li role="presentation">
        <a href="#block2" aria-controls="block2" role="tab" data-toggle="tab">首页2栏区块</a>
      </li>

      <li role="presentation">
        <a href="#featurepost" aria-controls="featurepost" role="tab" data-toggle="tab">首页特色文章</a>
      </li>

      <li role="presentation">
        <a href="#fullwidth" aria-controls="fullwidth" role="tab" data-toggle="tab">首页文案</a>
      </li>

      <li role="presentation">
        <a href="#textblock" aria-controls="textblock" role="tab" data-toggle="tab">首页文字区块</a>
      </li>
